        ...
        <nav class="navbar navbar-expand-md navbar-light shadow-sm z-3">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="fs-1 animate-charcter">
                        &lt;My_developer/&gt;
                    </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ url('profile') }}">{{ __('Impostazioni Utente') }}</a>
                                    <a class="dropdown-item" href="{{ url('admin') }}">{{ __('Profilo Developer') }}</a>
                                    <a class="dropdown-item" href="{{ url('reviews') }}">{{ __('Reviews') }}</a>
                                    <a class="dropdown-item" href="{{ url('leads') }}">{{ __('Messaggi') }}</a>
                                    <a class="dropdown-item" href="{{ url('sponsorship') }}">{{ __('Sponsorizza') }}</a>
